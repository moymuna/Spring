...
import com.emranhss.HRM_system.user.CustomUserDetailsService;
...
public class SecurityConfig {
    ...
    /** Browser origins allowed to call the API; override with app.cors.allowed-origins. */
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/auth/login", "/api/auth/signup",
                                ...
                                "/api/auth/verify-email", "/api/auth/send-verification",
